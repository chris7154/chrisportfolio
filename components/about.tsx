...
export default function About() {
  return (
    ...
    scroll-mt-28 text-center leading-8 sm:mb-40'
      ...
      >
        ...
        <p className='mb-3  '>
           ...
           <span className='font-medium'>React, Next.js, Node.js, and MongoDB</span> I am also familiar with TypeScript and Prisma.
        ...
        <p>
            ...
            playing Chess, solving word puzzles. I also enjoy {" "}
            <span className='font-medium'>Learning new things</span>. I am 
            currently learning about {" "} <span className='font-medium'>Leadership and team-bonding </span>. 
